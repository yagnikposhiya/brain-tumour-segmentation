...
class CascadedMobileNetV3LargeUNet(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log('cascaded_mobilenetv3_large_train_dice', dice, on_step=True, on_epoch=True, prog_bar=True, enable_graph=True) # save the dice logs for visualization
        self.log('cascaded_mobilenetv3_large_train_jaccard', jaccard, on_step=True, on_epoch=True, prog_bar=True, enable_graph=True) # save the jaccard logs for visualization
        self.log('cascaded_mobilenetv3_large_train_sensitivity', sensitivity, on_step=True, on_epoch=True, prog_bar=True, enable_graph=True) # save the sensitivity logs for visualization
        self.log('cascaded_mobilenetv3_large_train_specificity', specificity, on_step=True, on_epoch=True, prog_bar=True, enable_graph=True) # save the specificity logs for visualization
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.log('cascaded_mobilenetv3_large_valid_dice', dice, on_step=True, on_epoch=True, prog_bar=True, enable_graph=True) # save the dice logs for visualization
        self.log('cascaded_mobilenetv3_large_valid_jaccard', jaccard, on_step=True, on_epoch=True, prog_bar=True, enable_graph=True) # save the jaccard logs for visualization
        self.log('cascaded_mobilenetv3_large_valid_sensitivity', sensitivity, on_step=True, on_epoch=True, prog_bar=True, enable_graph=True) # save the sensitivity logs for visualization
        self.log('cascaded_mobilenetv3_large_valid_specificity', specificity, on_step=True, on_epoch=True, prog_bar=True, enable_graph=True) # save the specificity logs for visualization
