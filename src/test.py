...
from utils.utils import load_saved_model, available_models, prepareImageForInference, groundTruthVSPredicted_AllClasses
...
if __name__=='__main__':
    ...
    loaded_model = load_saved_model(model_class=model_class,num_classes=config.NUM_CLASSES,learning_rate=config.LEARNING_RATE) # load saved trained model
